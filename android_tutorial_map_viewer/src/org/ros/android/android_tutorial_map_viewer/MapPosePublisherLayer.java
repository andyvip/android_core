...
//                        goalPublisher.publish(message);
    ...
    public void onStart(final VisualizationView view, ConnectedNode connectedNode) {
        ...
        initialPosePublisher = connectedNode.newPublisher(initialPoseTopic,
                "geometry_msgs/PoseWithCovarianceStamped");
        androidGoalPublisher = connectedNode.newPublisher(simpleGoalTopic,
                "geometry_msgs/PoseStamped");
        goalPublisher = connectedNode.newPublisher(moveBaseGoalTopic,
